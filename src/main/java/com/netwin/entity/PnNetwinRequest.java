...
public class PnNetwinRequest {
	@Id
	@GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "PNADHREQMAS_SEQ")
	@SequenceGenerator(name = "PNADHREQMAS_SEQ", sequenceName = "PNADHREQMAS_SEQ", allocationSize = 1)
