...
@Lazy
@Autowired
public AharNtwnRequestController(AharNtwnRequestService aharNtwnRequestService,ErrorApplicationService errorApplicationService) {
	...
	public ResponseEntity<String> callAharRequest(@RequestBody(required = false) String aharJson, HttpServletRequest request) {
